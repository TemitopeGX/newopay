            ...
            <div className="container mx-auto px-4 sm:px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            <div className="flex gap-3 sm:gap-4">
                                ...
                                <div>
                                    <h3 className="text-base sm:text-lg font-bold text-black mb-1">The Beginning</h3>
                                    <p className="text-sm sm:text-base text-gray-600">OPay was founded with a vision to transform digital payments in Nigeria</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 sm:gap-4">
                                <div className="flex-shrink-0">
                                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-primary flex items-center justify-center">
                                        <span className="text-white font-bold text-xs sm:text-sm">2020</span>
                                    </div>
                                </div>
                                <div>
                                    <h3 className="text-base sm:text-lg font-bold text-black mb-1">Rapid Growth</h3>
                                    <p className="text-sm sm:text-base text-gray-600">Reached 10 million users and expanded our services nationwide</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 sm:gap-4">
                                ...
                                <div>
                                    <h3 className="text-base sm:text-lg font-bold text-black mb-1">Leading the Way</h3>
                                    <p className="text-sm sm:text-base text-gray-600">35+ million users trust OPay for their daily financial needs</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="relative overflow-hidden border border-gray-200 rounded-lg sm:rounded-xl md:rounded-2xl">
                            <video
                                autoPlay
                                loop
                                muted
